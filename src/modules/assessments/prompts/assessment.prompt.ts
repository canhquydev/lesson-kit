...
4. question_type chỉ được là: ${Object.values(AssessmentQuestionType).join(', ')}.
5. multiple_choice: options phải có đúng 4 lựa chọn khác nhau và correct_answer phải khớp một lựa chọn.
6. true_false: options phải là ["True", "False"] và correct_answer phải là "True" hoặc "False".
7. matching hoặc short_answer: options phải là mảng rỗng [].
8. explanation phải giải thích ngắn gọn vì sao đáp án đúng.
9. Kết hợp hình thức phù hợp với nội dung, khối ${context.grade} và thời lượng; sort_order liên tiếp bắt đầu từ 1.
10. Chỉ trả về một JSON object hợp lệ, không Markdown, không giải thích ngoài JSON.
