...
export const activities = [
  {
    ...
    descVi:
      "Học sinh thả xe đồ chơi trên các mặt phẳng nghiêng khác nhau, dự đoán xe nào xuống trước rồi đo gia tốc.",
...

  {
    ...
    descVi:
      "Dùng dữ liệu từ cuộc đua, các cặp vẽ đồ thị vận tốc–thời gian và giải thích độ dốc chính là gia tốc.",
...

  {
    ...
    descVi:
      "Học sinh ghép các tình huống đời thực (thang máy, xe buýt phanh) với loại chuyển động biến đổi phù hợp.",
...
export const assessments = [
...

  {
    ...
    guide:
      "Answer should mention constant gravitational acceleration (≈ 9.8 m/s²).",
...
export const script = [
  {
    ...
    viCue:
      "[Học sinh trả lời bằng ví dụ thực tế: xe máy tăng tốc, thang máy...]",
  },
