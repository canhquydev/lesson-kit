    ...
    <div className="mx-auto max-w-[1600px] px-6 py-8">
      ...
      <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-[13.5px] text-slate-500">
            Biên soạn và quản lý các bộ học liệu song ngữ theo khung chương
            trình phổ thông
          </p>
        </div>
        <button
      ...
      <div className="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-3">
        <div className="rounded-[12px] border border-slate-200 bg-white p-4 shadow-2xs">
          ...
          <p className="mt-1 font-display text-[22px] font-bold text-slate-900">
            {kits.length}
          </p>
        </div>
        <div className="rounded-[12px] border border-slate-200 bg-white p-4 shadow-2xs">
        ...
        <div className="rounded-[12px] border border-slate-200 bg-white p-4 shadow-2xs">
          ...
          <p className="mt-1 font-display text-[22px] font-bold text-amber-600">
            {
              kits.filter((k) => k.status?.toLowerCase() === "generating")
                .length
            }
          </p>
        </div>
            ...
            <tbody>
              {loading ? (
                ...
                <tr>
                  <td
                    colSpan={8}
                    className="px-5 py-16 text-center text-[14px] text-slate-400"
                  >
                    {kits.length === 0
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5">
                        <SubjectBadge
                          subject={SUBJECT_DISPLAY[k.subject] || k.subject}
                        />
                      </td>
                      ...
                      <td className="px-4 py-3.5">
                        <CefrPill level={k.support_level} />
                      </td>
