      ...
      {tabs.map((t) => {
        ...
        return (
          ...
          >
            ...
            {count !== undefined && (
              <span
                className={`ml-1.5 rounded-full px-2 py-0.5 font-mono text-[11px] font-semibold transition-colors ${
                  on
...
const toastConfig: Record<ToastType, {
  ...
  success: {
    container:
      "border-emerald-200 bg-white text-slate-800 shadow-xl shadow-emerald-900/10",
  ...
  error: {
    container:
      "border-rose-200 bg-white text-slate-800 shadow-xl shadow-rose-900/10",
  ...
  info: {
    container:
      "border-indigo-200 bg-white text-slate-800 shadow-xl shadow-indigo-900/10",
...
export function ToastContainer() {
  ...
  return (
    <div className="fixed bottom-5 right-5 z-[99999] flex flex-col gap-2.5 pointer-events-none max-w-sm w-full">
      {toasts.map((t) => {
        ...
        return (
          ...
          >
            <div
              className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${conf.iconBg}`}
            >
